CLASS zcl_rap_fill_team DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap_fill_team IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA team_members TYPE STANDARD TABLE OF zdjs_team WITH EMPTY KEY.
    ...
    DELETE FROM zdjs_team.
    INSERT zdjs_team FROM TABLE @team_members.
    COMMIT WORK.
